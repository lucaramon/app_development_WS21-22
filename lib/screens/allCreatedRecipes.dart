...
class allCreatedRecipes extends StatefulWidget {
  const allCreatedRecipes({Key key}) : super(key: key);

  _allCreatedRecipesState createState() => _allCreatedRecipesState();
}

class _allCreatedRecipesState extends State<allCreatedRecipes> {
  ...
  var boxAllCreatedRecipesToRecipes = Hive.box('pushkeyAllCreatedRecipes');
                  ...
                  SingleChildScrollView(
                    child: ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        return InkWell(
                          onTap: () {
                            boxAllCreatedRecipesToRecipes.put(
                                'pushkeyAllCreatedRecipes', recipeCode[index]);
                            Navigator.push(
                                context,
                                MaterialPageRoute(
                          ...
                          children: <Widget>[
                            ListTile(
                              title: Padding(
                                ...
                                child: Text("You have not yet created any recipes."),
                              ),
  ...
  Future getDataFromFirebase() {
    ...
    if (boxAllCreatedRecipes.get("$currentLoggedInUserEmail") != null) {
      recipeCode = boxAllCreatedRecipes.get("$currentLoggedInUserEmail");
    }
